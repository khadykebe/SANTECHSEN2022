                            ...
                            <div class="widget style1 navb-bg" style="background-color: #ffffff">
                                <div class="row">
                                    <div class="col-xs-6">
                                        ...
                                        <h4 class="font-bold"><u> date de creation </u>:</h4><br>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Ajout de type page</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{route('create.typepage')}}" method="POST"  class="form-validate" >
                        @csrf
                        @method('POST')
                        <div class="col-sm-6 col-sx-12">
                            <div class="form-group">
                                <label for="">nom</label>
                                <input type="text" name="nomType" id="nomType" class="form-control" placeholder=""
